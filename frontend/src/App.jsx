...
export default function App() {
  ...
  // CHANGED: Default to the stable Gemini 3 Pro Preview
  ...
  // Check if using GPT Audio model
            ...
            <div className="row" style={{ gridTemplateColumns: "1fr 1fr 1fr", gap: '12px' }}>
              <div>
                ...
                <select value={modelId} onChange={(e) => setModelId(e.target.value)}>
                  {/* CHANGED: Removed broken 2.0 models to prevent 404/429 errors */}
                ...
                <div key={idx} className={`message ${msg.role}`}>
                  ...
                  {msg.midiDownloadUrl && (
                    <div className="midi-attachment">
                      ...
                      <a
                        href={`${API_BASE_URL}${msg.midiDownloadUrl}`}
                        download
